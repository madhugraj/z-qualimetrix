...
function LoginPage() {
  ...
  return (
    <div className="qm-night relative min-h-screen overflow-hidden flex flex-col">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-6xl px-5 pb-28 flex flex-1 items-center justify-center">
